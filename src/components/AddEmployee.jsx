    ...
    <div className="bg-white m-8 p-6 rounded-xl shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select value={Dept} required onChange={(e)=>setDept(e.target.value)} className="border px-3 py-2 w-full rounded-lg outline-none focus:ring-2 focus:ring-blue-400">
            <option>IT</option>
            <option>HR</option>
            <option>Sales</option>
        ...
        <div>
          ...
          <select value={Status} required onChange={(e)=>setStatus(e.target.value)} className="border px-3 py-2 w-full rounded-lg outline-none focus:ring-2 focus:ring-blue-400">
